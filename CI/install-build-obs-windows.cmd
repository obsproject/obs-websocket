...
if defined BuildOBS (
	...
	cd build32
	cmake -G "Visual Studio 16 2019" -DBUILD_CAPTIONS=true -DDISABLE_PLUGINS=true -DCOPIED_DEPENDENCIES=false -DCOPY_DEPENDENCIES=true ..
	echo:
	echo:
	
    echo   Running cmake for obs-studio %OBSLatestTag% 64-bit...
	cd ..\build64
	cmake -G "Visual Studio 16 2019 Win64" -DBUILD_CAPTIONS=true -DDISABLE_PLUGINS=true -DCOPIED_DEPENDENCIES=false -DCOPY_DEPENDENCIES=true ..
	echo:
	echo:
