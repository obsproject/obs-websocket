...
namespace Utils {
	namespace Obs {
		...
		namespace ActionHelper {
            ...
            obs_source_t *CreateSourceFilter(obs_source_t *source, std::string filterName, std::string filterKind, obs_data_t *filterSettings, int filterIndex); // Increments source ref. Use OBSSourceAutoRelease
